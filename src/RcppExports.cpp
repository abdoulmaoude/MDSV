...
// logLik
double logLik(const Eigen::Map<Eigen::VectorXd>& para_tilde, const Eigen::MatrixXd& ech, const int& Model_type, const bool& LEVIER, const int& K, const int& N, const int& Nl, const Rcpp::Nullable<Rcpp::Function>& fixed_pars, const Rcpp::Nullable<Rcpp::Function>& fixed_values);
RcppExport SEXP _MDSV_logLik(SEXP para_tildeSEXP, SEXP echSEXP, SEXP Model_typeSEXP, SEXP LEVIERSEXP, SEXP KSEXP, SEXP NSEXP, SEXP NlSEXP, SEXP fixed_parsSEXP, SEXP fixed_valuesSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Eigen::Map<Eigen::VectorXd>& >::type para_tilde(para_tildeSEXP);
    ...
    Rcpp::traits::input_parameter< const Rcpp::Nullable<Rcpp::Function>& >::type fixed_pars(fixed_parsSEXP);
    Rcpp::traits::input_parameter< const Rcpp::Nullable<Rcpp::Function>& >::type fixed_values(fixed_valuesSEXP);
    rcpp_result_gen = Rcpp::wrap(logLik(para_tilde, ech, Model_type, LEVIER, K, N, Nl, fixed_pars, fixed_values));
    return rcpp_result_gen;
END_RCPP
}
// logLik2
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_MDSV_logLik", (DL_FUNC) &_MDSV_logLik, 9},
